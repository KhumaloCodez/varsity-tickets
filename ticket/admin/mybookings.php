    ...
    <?php
        ...
        */
        ...
        $userID = $_SESSION['user_id'];
            $resultSql = "SELECT * FROM `bookings` WHERE userID = $userID  ORDER BY booking_created DESC";
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        ...
                        <p class="fw-light">Make your first booking!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                             Click on <a href="book.php"  class="button btn-sm"> AND </a> book a ticket for event!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="bus">
                <div id="head">
                    <h4>List of your previous booking(s)</h4>
                </div>
                <div id="bus-results">
				...
				$bookingID = $row["bookingID"];
                        ...
                        <tr>
                           ...
                           <td>
                            <a href="tic/dist/ticket.php?id=<?php echo $bookingID; ?>" style="text-decoration:none;"><b>View Ticket</b></a>
