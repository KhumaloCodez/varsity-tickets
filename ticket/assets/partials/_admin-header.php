...
<!-- <header>
    ...
    <main id="container">
        <div id="sidebar">
            <h4><i class="fas fa-list"></i> Events</h4>
            <div>
            ...
            <ul id="options">
                ...
                <li class="option <?php if($page=='university'){ echo 'active';}?>">
                    <a href="./university.php">
                    <i class="fas fa-home"></i> University
                    </a>
                </li>
                <li class="option <?php if($page=='event'){ echo 'active';}?>">
                    <a href="./event.php">
                    <i class="fas fa-list"></i> Events    
                    </a>
                </li>
                
                <li class="option <?php if($page=='students'){ echo 'active';}?>">
                    <a href="">
                    <i class="fas fa-users"></i> Students
                    </a>
                </li>
                <li class="option <?php if($page=='bookings'){ echo 'active';}?>">
                    <a href="bookings.php">
